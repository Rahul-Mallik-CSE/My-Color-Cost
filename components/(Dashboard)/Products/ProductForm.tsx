      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-8">
        ...
        <div className="lg:col-span-2 space-y-4 sm:space-y-8">
          ...
          >
            ...
            <div className="bg-white p-4 sm:p-6 md:p-8 rounded-3xl shadow-[0px_4px_20px_rgba(0,0,0,0.03)] border border-gray-100/50">
        ...
        <div className="space-y-4 sm:space-y-8">
          {/* Media Upload */}
          <div className="bg-white p-4 sm:p-6 rounded-3xl shadow-[0px_4px_20px_rgba(0,0,0,0.03)] border border-gray-100/50 h-fit">
            ...
            <div
              ...
              className={cn(
                "border-2 border-dashed rounded-2xl p-4 flex flex-col items-center justify-center text-center cursor-pointer transition-all duration-200 relative overflow-hidden group min-h-[200px] sm:min-h-[300px]",
                imagePreview
            ...
            >
              ...
              {imagePreview ? (
                <div className="relative w-full h-full min-h-[180px] sm:min-h-[280px] flex items-center justify-center group-hover:opacity-90 transition-opacity">
                  <Image
                    src={imagePreview}
                    alt="Preview"
                    fill
          ...
          <div className="bg-white p-4 sm:p-6 rounded-3xl shadow-[0px_4px_20px_rgba(0,0,0,0.03)] border border-gray-100/50">
            <div className="flex flex-col gap-3">
              ...
              <Link
                href="/products"
                className="w-full py-3 px-4 sm:py-3.5 sm:px-6 rounded-xl border border-gray-200 text-center text-gray-600 font-bold hover:bg-gray-50 hover:border-gray-300 transition-all"
              >
                Discard Changes
              </Link>
            </div>
